...
show_labels = st.sidebar.checkbox("🏷️ Mostrar Rótulos", value=True)
    ...
    try:
        if model_option == "Modelo Customizado":
            ...
            if os.path.exists(model_path):
                ...
                st.sidebar.warning("⚠️ Modelo customizado não encontrado. Usando modelo pré-treinado.")
...
if detector:
    ...
    # Tabs principais
    tab1, tab2, tab3, tab4 = st.tabs(["📷 Análise de Imagens", "🎥 Análise de Vídeos", "📊 Estatísticas", "ℹ️ Sobre"])
...
st.markdown(
    ...
    <div style='text-align: center; color: #666;'>
        📱 Detector de Pessoas com Celular | Desenvolvido com ❤️ usando Streamlit<br>
